...
bad=open("C:/Users/SKsaqlain/Desktop/AE/test_processed.txt",'r')
good=open("C:/Users/SKsaqlain/Desktop/AE/train_processed.txt",'r')
...
X_train, X_test, y_train, y_test = train_test_split(good_processed, good_y, test_size=0.20, random_state=58)
